...
// Remote images are the tracking-pixel vector, so src is dropped and the original kept in
// data-stampyx-src for the panel to offer behind a "load images" control.
